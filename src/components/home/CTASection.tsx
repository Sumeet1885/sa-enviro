 ...
 export const CTASection = () => {
   return (
     <section className="section-padding bg-gradient-to-br from-water-ocean via-water-sea to-water-deep text-primary-foreground relative overflow-hidden">
       {/* Background Elements */}
       ...
       <div className="container-wide relative z-10">
         <div className="max-w-3xl mx-auto text-center">
           <AnimatedSection>
             ...
             <p className="text-water-light/90 text-lg mb-8 max-w-2xl mx-auto">
             ...
             <div className="flex flex-col sm:flex-row justify-center gap-4">
               <Button
                 asChild
                 size="lg"
                 className="bg-primary-foreground text-primary hover:bg-water-light font-semibold"
               >
                 <Link to="/contact">
                   Get Free Quote
