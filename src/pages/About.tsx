         ...
         <div className="container-wide">
           <StaggerContainer className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
             {[
               ...
               { icon: Users, title: "Expert Team", desc: "Qualified professionals" },
               { icon: Building2, title: "Modern Facility", desc: "State-of-the-art workshop" },
               { icon: MapPin, title: "Located in Pune", desc: "Chinchwad, Maharashtra" }
             ].map((item, i) => (
               <StaggerItem key={i}>
